...
function Snake() {
    ...
    this.move = function () {
        ...
        if (this.bodySnake[0].x < 0) {
            this.bodySnake[0].x = gameSize - unitGame;
        }
        if (this.bodySnake[0].x > gameSize - unitGame) {
            this.bodySnake[0].x = 0;
        }
        if (this.bodySnake[0].y < 0) {
            this.bodySnake[0].y = gameSize - unitGame;
        }
        if (this.bodySnake[0].y > gameSize - unitGame) {
            this.bodySnake[0].y = 0;
        }
        this.showSnake();
    }
